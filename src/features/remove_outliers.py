...
df[["acc_y", "label"]].boxplot(by="label",figsize=(20,10),layout=(1,1))

for col in outliers_columns[:3]:
  df[[col,"label"]].boxplot(by="label")
  plt.xlabel("label")
  plt.ylabel(col)
  plt.suptitle("")
...
df[outliers_columns[:3]+["label"]].plot.hist(by="label",figsize=(20,20),layout=(2,3))
df[outliers_columns[3:]+["label"]].plot.hist(by="label",figsize=(20,20),layout=(2,3))
